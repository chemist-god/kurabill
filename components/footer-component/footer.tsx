        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-16">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/pharmacists/testimonials" className="hover:underline">Testimonials</Link></li>
              <li><Link href="/pharmacists/faqs" className="hover:underline">FAQs</Link></li>
              <li><Link href="/pharmacists/about" className="hover:underline">About Us</Link></li>
            </ul>
          </div>
